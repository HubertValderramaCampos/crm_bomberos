...
async function getData() {
  ...
  }>(`SELECT id, fecha::text, entidad, resumen, respuesta FROM oficio_varios ORDER BY fecha DESC`);
  return rows;
}
...
export default async function OficiosVariosPage() {
  ...
  return (
    <div className="space-y-4 pb-6">
      <PageHeader icon={FileText} title="Oficios Varios" subtitle={`${rows.length} registros`} />
